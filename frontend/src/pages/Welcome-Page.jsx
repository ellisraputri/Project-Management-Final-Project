      ...
      <div className="bg-white shadow-lg rounded-2xl p-8 w-full max-w-lg mt-4">
        <div className="flex flex-col space-y-6">
          <div className="text-left">
            <label className="block text-[#1E1e1e] font-medium mb-1 text-lg" style={{ fontFamily: "Nunito" }}>Enter Your Name</label>
            <input
              type="text"
              value={name}
          ...
          <div className="text-left mt-2 mb-10">
            <label className="block text-[#1E1e1e] font-medium mb-1 text-lg" style={{ fontFamily: "Nunito" }}>Enter Quiz Code</label>
            <input
              type="text"
              value={quizCode}
              style={{ fontFamily: "Nunito" }}
          ...
          <button
            onClick={handleStart}
            className="self-center w-1/3 py-3 rounded-full bg-[#6D94C5] cursor-pointer text-white font-bold text-lg hover:bg-[#4c6e98] transition"
          >
            START
          </button>
        </div>
